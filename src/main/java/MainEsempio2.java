...
public class MainEsempio2 {
    ...
    public static void main(String[] args) {
        ...
        // Creazione di un robot con un comando loop "REPEAT"
        Robot robot1 = new Robot(0, 0, 0);
        controllerRobot.executeCommandLoop(robot1, RobotCommand.REPEAT, 3, true, null);

        // Creazione di un secondo robot con un comando loop "FOREVER"
        Robot robot2 = new Robot(5, 5, 0);
        controllerRobot.executeCommandLoop(robot2, RobotCommand.FOREVER, 0, true, null);
        ...
        // Avvio della simulazione con un intervallo di tempo di 2 secondi e una durata totale di 10 secondi
        simulator.simulate(2.0, 10.0);
    }
}
